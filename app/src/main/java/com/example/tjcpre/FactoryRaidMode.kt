...
class FactoryRaidMode  : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var EditmodeButton : Button = findViewById(R.id.Factory_EditMode)
        var clearButton : Button = findViewById(R.id.Factory_Clear)
        var UploadButtton : Button = findViewById(R.id.Factory_UploadButton)
                ...
                UploadButtton.setOnClickListener {
                    ...
                    with(builder) {
                        ...
                        setPositiveButton("OK"){dialog, which ->
                            ...
                            val pathsRef = storageRef.child("Paths/${UID}/Factory/${name}.PNG")
                            ...
                            uploadTask.addOnFailureListener{
                                ...
                                Firebase.firestore.collection("testUsers").document("${UID}")
                                    .collection("Paths").document("Factory")
                                    .get().addOnSuccessListener{
                                        if (!it.contains("count")){
                                            val dataBase = Firebase.firestore
                                            val UserItemDoc = dataBase.document("testUsers/${UID}/Paths/Factory")
                                ...
                                val pathnamedoc = dataBase.document("testUsers/${UID}/Paths/FactoryNames")
        ...
        if (SelectPath){
            ...
            pathsRef.getBytes(5242880*2) // 10mb max size download
                .addOnSuccessListener { bytes ->
                    ...
                    FactoryMap.setImageBitmap(bitmap)
        ...
        EditmodeButton.setOnClickListener(){
            ...
            FactoryMap.isClickable = !(paintView.isClickable)
            if (isClick) {
