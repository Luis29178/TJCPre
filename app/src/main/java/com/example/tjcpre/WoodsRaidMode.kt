...
class WoodsRaidMode  : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var EditmodeButton : Button = findViewById(R.id.Woods_EditMode)
        var clearButton : Button = findViewById(R.id.Woods_Clear)
        var UploadButtton : Button = findViewById(R.id.Woods_UploadButton)
                ...
                UploadButtton.setOnClickListener {
                    ...
                    with(builder) {
                        ...
                        setPositiveButton("OK"){dialog, which ->
                            ...
                            val pathsRef = storageRef.child("Paths/${UID}/Woods/${name}.PNG")
                            ...
                            uploadTask.addOnFailureListener{
                                ...
                                Firebase.firestore.collection("testUsers").document("${UID}")
                                    .collection("Paths").document("Woods")
                                    .get().addOnSuccessListener{
                                        if (!it.contains("count")){
                                            val dataBase = Firebase.firestore
                                            val UserItemDoc = dataBase.document("testUsers/${UID}/Paths/Woods")
                                ...
                                val pathnamedoc = dataBase.document("testUsers/${UID}/Paths/WoodsNames")
        ...
        var CustomsMap : ZoomableImage = findViewById(R.id.WoodsMap)
        if (SelectPath){
            ...
            CustomsMap.setImageBitmap(BitmapFactory.decodeResource(resources,R.drawable.woodsmap))
        }
