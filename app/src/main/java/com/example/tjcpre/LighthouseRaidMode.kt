...
class LighthouseRaidMode : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var EditmodeButton : Button = findViewById(R.id.Lighthouse_EditMode)
        var clearButton : Button = findViewById(R.id.Lighthouse_Clear)
        var UploadButtton : Button = findViewById(R.id.Lighthouse_UploadButton)
                ...
                UploadButtton.setOnClickListener {
                    ...
                    with(builder) {
                        ...
                        setPositiveButton("OK"){dialog, which ->
                            ...
                            val pathsRef = storageRef.child("Paths/${UID}/Lighthouse/${name}.PNG")
                            ...
                            uploadTask.addOnFailureListener{
                                ...
                                Firebase.firestore.collection("testUsers").document("${UID}")
                                    .collection("Paths").document("Lighthouse")
                                    .get().addOnSuccessListener{
                                        if (!it.contains("count")){
                                            val dataBase = Firebase.firestore
                                            val UserItemDoc = dataBase.document("testUsers/${UID}/Paths/Lighthouse")
                                ...
                                val pathnamedoc = dataBase.document("testUsers/${UID}/Paths/LighthouseNames")
        ...
        var CustomsMap : ZoomableImage = findViewById(R.id.LighthouseMap)
        if (SelectPath){
            ...
            CustomsMap.setImageBitmap(BitmapFactory.decodeResource(resources,R.drawable.lighthousemap))
        }
