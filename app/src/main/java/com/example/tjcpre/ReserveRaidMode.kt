...
class ReserveRaidMode : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var EditmodeButton : Button = findViewById(R.id.Reserve_EditMode)
        var clearButton : Button = findViewById(R.id.Reserve_Clear)
        var UploadButtton : Button = findViewById(R.id.Reserve_UploadButton)
                ...
                UploadButtton.setOnClickListener {
                    ...
                    with(builder) {
                        ...
                        setPositiveButton("OK"){dialog, which ->
                            ...
                            val pathsRef = storageRef.child("Paths/${UID}/Reserve/${name}.PNG")
                            ...
                            uploadTask.addOnFailureListener{
                                ...
                                Firebase.firestore.collection("testUsers").document("${UID}")
                                    .collection("Paths").document("Reserve")
                                    .get().addOnSuccessListener{
                                        if (!it.contains("count")){
                                            val dataBase = Firebase.firestore
                                            val UserItemDoc = dataBase.document("testUsers/${UID}/Paths/Reserve")
                                ...
                                val pathnamedoc = dataBase.document("testUsers/${UID}/Paths/ReserveNames")
        ...
        var CustomsMap : ZoomableImage = findViewById(R.id.ReserveMap)
        if (SelectPath){
            ...
            CustomsMap.setImageBitmap(BitmapFactory.decodeResource(resources,R.drawable.reservemap))
        }
