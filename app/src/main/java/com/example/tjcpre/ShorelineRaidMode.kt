...
class ShorelineRaidMode : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var EditmodeButton : Button = findViewById(R.id.Shoreline_EditMode)
        var clearButton : Button = findViewById(R.id.Shoreline_Clear)
        var UploadButtton : Button = findViewById(R.id.Shoreline_UploadButton)
                ...
                UploadButtton.setOnClickListener {
                    ...
                    with(builder) {
                        ...
                        setPositiveButton("OK"){dialog, which ->
                            ...
                            val pathsRef = storageRef.child("Paths/${UID}/Shoreline/${name}.PNG")
                            ...
                            uploadTask.addOnFailureListener{
                                ...
                                Firebase.firestore.collection("testUsers").document("${UID}")
                                    .collection("Paths").document("Shoreline")
                                    .get().addOnSuccessListener{
                                        if (!it.contains("count")){
                                            val dataBase = Firebase.firestore
                                            val UserItemDoc = dataBase.document("testUsers/${UID}/Paths/Shoreline")
                                ...
                                val pathnamedoc = dataBase.document("testUsers/${UID}/Paths/ShorelineNames")
        ...
        var CustomsMap : ZoomableImage = findViewById(R.id.ShorelineMap)
        if (SelectPath){
            ...
            CustomsMap.setImageBitmap(BitmapFactory.decodeResource(resources,R.drawable.shorelinemap))
        }
