...
class InterchangeRaidMode  : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var EditmodeButton : Button = findViewById(R.id.Interchange_EditMode)
        var clearButton : Button = findViewById(R.id.Interchange_Clear)
        var UploadButtton : Button = findViewById(R.id.Interchange_UploadButton)
                ...
                UploadButtton.setOnClickListener {
                    ...
                    with(builder) {
                        ...
                        setPositiveButton("OK"){dialog, which ->
                            ...
                            val pathsRef = storageRef.child("Paths/${UID}/Interchange/${name}.PNG")
                            ...
                            uploadTask.addOnFailureListener{
                                ...
                                Firebase.firestore.collection("testUsers").document("${UID}")
                                    .collection("Paths").document("Interchange")
                                    .get().addOnSuccessListener{
                                        if (!it.contains("count")){
                                            val dataBase = Firebase.firestore
                                            val UserItemDoc = dataBase.document("testUsers/${UID}/Paths/Interchange")
                                ...
                                val pathnamedoc = dataBase.document("testUsers/${UID}/Paths/InterchangeNames")
        ...
        var CustomsMap : ZoomableImage = findViewById(R.id.InterchangeMap)
        if (SelectPath){
            ...
            CustomsMap.setImageBitmap(BitmapFactory.decodeResource(resources,R.drawable.interchangemap))
        }
